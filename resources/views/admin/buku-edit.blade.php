...
@section('content')
    ...
    <form action="{{ route('buku.update', $buku) }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
        @csrf
        @method('PUT')
        <div class="mb-4">
            ...
            <input type="text" id="nama_buku" name="nama_buku"
                ...
                placeholder="masukkan nama buku" value="{{ old('nama_buku', $buku->nama_buku) }}">
            @error('nama_buku')
        ...
        <div class="mb-4">
            ...
            <textarea id="deskripsi_buku" name="deskripsi_buku" rows="4"
                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                placeholder="masukkan deskripsi buku">{{ old('deskripsi_buku', $buku->deskripsi_buku) }}</textarea>
                ...
                @foreach ($kategoris as $kategori)
                    <div class="flex items-center">
                        <input type="checkbox" id="kategori_{{ $kategori->id }}" name="kategori[]"
                            ...
                            @if (old('kategori') ? in_array($kategori->id, old('kategori')) : $buku->kategori->contains('id', $kategori->id)) checked @endif>
